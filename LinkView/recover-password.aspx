<%@ Page Title="Password Recovery" Language="C#" AutoEventWireup="true" CodeFile="recover-password.aspx.cs" Inherits="recover_password" EnableViewState="false" %>
<%@ Register Src="recover-password.ascx" TagName="recover" TagPrefix="uc1" %>
                ...
                <div class="container">
                    <div class="s_itms">
                        <span style="text-align: left">
                           <uc1:recover ID="recover2" runat="server" />    
                        </span>
                    </div>
                </div>
                <div class="clear"></div>
